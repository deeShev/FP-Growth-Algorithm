...
public abstract class MiningBlock implements Cloneable, Serializable {
	...
	final protected EMiningFunctionSettings functionSettings;
	final protected EMiningAlgorithmSettings algorithmSettings;

	protected ArrayList<BlockExecuteListener> listenersBeforeExecute = new ArrayList<BlockExecuteListener>();
