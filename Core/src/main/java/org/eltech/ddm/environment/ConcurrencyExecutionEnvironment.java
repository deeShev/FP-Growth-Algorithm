...
//	private void fullExecutorsByData(MiningExecutor executor){
//		if(executor.getDataBlocks() != null)
//			executor.setData(data);
//
//		List<MiningParallel> parallels = executor.getParallelBlocks();
//		if(parallels == null)
//			return;
//
//		for(MiningParallel mp: parallels){
//			List<MiningExecutor> execs = mp.getExecutors();
//			for(MiningExecutor ex: execs)
//				fullExecutorsByData(ex);
//		}
//	}
