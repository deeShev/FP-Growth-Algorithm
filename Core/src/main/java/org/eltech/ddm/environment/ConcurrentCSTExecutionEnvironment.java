 ...
 * @author Evgenii Ray
 */
public class ConcurrentCSTExecutionEnvironment extends ExecutionEnvironment {

    private static final Logger LOGGER = Logger.getLogger(ConcurrentCSTExecutionEnvironment.class.getName());
     ...
     */
    public ConcurrentCSTExecutionEnvironment(String file, int threadNumber) throws MiningException {
