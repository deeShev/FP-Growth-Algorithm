...
import org.eltech.ddm.associationrules.fpg.*;
...
public class FormConditionalLargeFPTreeAndFormItemSets extends MiningBlock {
     ...
     */
    public FormConditionalLargeFPTreeAndFormItemSets(EMiningFunctionSettings settings) throws MiningException {
        super(settings);
