...
public class NaiveBayesAlgorithmHorParallelTest extends NaiveBayesModelTest {
	...
	public void setUp() throws Exception {
		...
		algorithmSettings.setName(NaiveBayesAlgorithmHorParallel.class.getSimpleName());
		algorithmSettings.setClassname(NaiveBayesAlgorithmHorParallel.class.getName());
	...
	private EMiningBuildTask createBuidTask() throws MiningException{
		...
		MiningAlgorithm algorithm = new NaiveBayesAlgorithmHorParallel(miningSettings);
